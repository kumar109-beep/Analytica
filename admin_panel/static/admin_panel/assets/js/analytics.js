...
jQuery('.mt-3').on('click', '.view_detail_chart', function(e) {
    ...
    chart_conrol = {
        ...
        //                                     configuration_set.headDatasetConf = {   "sum_of_NHP Fund" : {label : "Fund recived from NHP (â‚¹)", stack:1}, 
                                                                                    
        //                                                                             "sum_of_Approved Budget" : {label : "Approved Budget (â‚¹)", stack:2},

        //                                                                             "sum_of_Six monthly Expenditure (Rs)" : {label : "Expenditure (â‚¹)", stack:3}
        ...
        //                                         configuration_set.headDatasetConf = {"sum_of_total_fund_amount_parted" : {label : "Total Fund (â‚¹)", stack:1}, 
                                                                                    
        //                                                                             "sum_of_Approved Budget" : {label : "Approved Budget (â‚¹)", stack:2},

        //                                                                             "sum_of_Six monthly Expenditure (Rs)" : {label : "Expenditure (â‚¹)", stack:3},

        //                                                                             "sum_of_Balance in Total" : {label : "Remaning Balance (â‚¹)", stack:4},
    ...
    try
    {
        chart_conrol = getChartDetails();
    }
    catch
    {
        console.log("No isolated conf js maintained")
    }
...
var FRAME_TO_CHART_REPORT_COLUMN = {
    ...
    fund_status_with_six_month_expenditure : [ "DISTRICT", "BLOCK",  "ctype", "Name of Committee", "RBF Cycle", "RBF Amount", "Activity Category", "Activities (approved in the Action Plan)",  "Approved Budget", "Six monthly Expenditure (Rs)", "activity_type" ],
